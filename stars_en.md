...
> [!info]
> ⭐ 2,455 · Rust · 2026-03-27  
> [GitHub](https://github.com/golutra/golutra) · [Website](https://www.golutra.com)  
> `#Multi-Agent Collaboration` `#AI CLI Orchestration` `#Tauri Desktop App` `#Rust + Vue3` `#agent` `#automation` `#chatgpt` `#claude` `#claude-code` `#codex` `#codex-cli` `#gemini` `#google` `#multi-agent` `#openai` `#openclaw` `#opencode` `#orchestration` `#qwen-coder` `#workflows` 
