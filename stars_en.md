...
> `#Document Sharing` `#DocSend Alternative` `#Self-hosted Documents` `#Next.js Full-stack` `#dataroom` `#next-auth` `#nextjs` `#open-source` `#pdf` `#postgresql` `#prisma` `#tailwindcss` `#typescript` `#zod` 
